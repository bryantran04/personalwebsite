                            ...
                            <FadeInSection>
                                <div class="row mt-5 " key={key}>
                                    ...
                                    <div className="col-md-6 img-container">
                                        <img className="about-img" src={`images/${item["img"]}`}></img>
                                    </div>
